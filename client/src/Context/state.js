...
const ProviderState = ({ children }) => {
    ...
    return (
        ...
        <context.Provider value={{ isusersignin, isAdmin, isprofilename, list,user,Movie,addMovie,deleteItem,getMovie,movieData,id,setId,loading,AddTheatre,deleteTheatre,updateUser}}>
            { children }
        </context.Provider>
    )
}
